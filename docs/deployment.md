...
4. Open the printed desk link on the Mac. Enter the private `CONTROL_TOKEN`, connect the desk, and click **Play**. Open the printed audience link in Quest Browser over Wi-Fi, choose **Low**, then **Enter MR** and use the Quest system button long-press to recenter. Two-point floor alignment is temporarily disabled.
